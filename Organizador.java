...
public class Organizador {
    ...
    public Organizador (String imprime_menu, int ejecutar, int imprimir_informe, int longitud_mundo, int ancho_mundo, int altura_mundo, int numero_de_pistas, int imprime_pistas, Controlador controler, int imprime_enemigos){
